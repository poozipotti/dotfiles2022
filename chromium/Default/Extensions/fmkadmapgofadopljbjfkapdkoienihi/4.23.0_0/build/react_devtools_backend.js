...
/* harmony import */ var shared_ReactSymbols__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(23);
...
/* harmony import */ var _renderer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(17);
/* harmony import */ var _DevToolsFiberComponentStack__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(25);
...
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(14);
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var backend_console = __webpack_require__(12);
...
class agent_Agent extends events["a" /* default */] {
  constructor(bridge) {
    ...
    if (Object(storage["c" /* sessionStorageGetItem */])(constants["i" /* SESSION_STORAGE_RELOAD_AND_PROFILE_KEY */]) === 'true') {
      this._recordChangeDescriptions = Object(storage["c" /* sessionStorageGetItem */])(constants["h" /* SESSION_STORAGE_RECORD_CHANGE_DESCRIPTIONS_KEY */]) === 'true';
      this._isProfiling = true;
    ...
    const persistedSelectionString = Object(storage["c" /* sessionStorageGetItem */])(constants["g" /* SESSION_STORAGE_LAST_SELECTION_KEY */]);
...
function setup(hook) {
  ...
  const setupNativeStyleEditor = __webpack_require__(36).default;
...
var backend_renderer = __webpack_require__(17);
