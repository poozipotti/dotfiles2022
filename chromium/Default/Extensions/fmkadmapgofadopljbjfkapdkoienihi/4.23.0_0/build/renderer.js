...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "D", function() { return __PERFORMANCE_PROFILE__; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return TREE_OPERATION_ADD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return TREE_OPERATION_REMOVE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "x", function() { return TREE_OPERATION_REORDER_CHILDREN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "A", function() { return TREE_OPERATION_UPDATE_TREE_BASE_DURATION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "z", function() { return TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "w", function() { return TREE_OPERATION_REMOVE_ROOT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "y", function() { return TREE_OPERATION_SET_SUBTREE_MODE; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return SESSION_STORAGE_RECORD_CHANGE_DESCRIPTIONS_KEY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return SESSION_STORAGE_RELOAD_AND_PROFILE_KEY; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "B", function() { return UNSUPPORTED_VERSION_URL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return REACT_DEVTOOLS_WORKPLACE_URL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return THEME_STYLES; });
...
/* harmony import */ var react_devtools_shared_src_backend_renderer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(47);
/**
...
function printOperationsArray(operations) {
  ...
  while (i < operations.length) {
    ...
    switch (operation) {
      case constants["u" /* TREE_OPERATION_ADD */]:
        {
      ...
      case constants["v" /* TREE_OPERATION_REMOVE */]:
        {
      ...
      case constants["w" /* TREE_OPERATION_REMOVE_ROOT */]:
        {
          i += 1;
      ...
      case constants["y" /* TREE_OPERATION_SET_SUBTREE_MODE */]:
        {
          const id = operations[i + 1];
      ...
      case constants["x" /* TREE_OPERATION_REORDER_CHILDREN */]:
        {
          const id = operations[i + 1];
      ...
      case constants["A" /* TREE_OPERATION_UPDATE_TREE_BASE_DURATION */]:
      ...
      case constants["z" /* TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS */]:
        const id = operations[i + 1];
...
/* harmony import */ var _renderer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(47);
/* harmony import */ var _DevToolsFiberComponentStack__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(65);
...
const Yallist = __webpack_require__(58);
...
var react_debug_tools = __webpack_require__(64);
...
// EXTERNAL MODULE: ../react-devtools-shared/src/isArray.js
var src_isArray = __webpack_require__(15);
...
var src_constants = __webpack_require__(35);
...
function createProfilingHooks({
  ...
  function markComponentSuspended(fiber, wakeable, lanes) {
    if (supportsUserTimingV3) {
      ...
      const displayName = wakeable.displayName || ''; // TODO (timeline) Record and cache component stack
...
function attach(hook, rendererID, renderer, global) {
  ...
  function updateComponentFilters(componentFilters) {
    ...
    hook.getFiberRoots(rendererID).forEach(root => {
      ...
      pushOperation(constants["w" /* TREE_OPERATION_REMOVE_ROOT */]);
  ...
  function recordPendingErrorsAndWarnings() {
    ...
    fibersWithChangedErrorOrWarningCounts.forEach(fiber => {
      ...
      if (fiberID === null) {// Don't send updates for Fibers that didn't mount due to e.g. Suspense or an error boundary.
        ...
        pushOperation(constants["z" /* TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS */]);
  ...
  function flushPendingEvents(root) {
    ...
    if (numUnmountIDs > 0) {
      ...
      operations[i++] = constants["v" /* TREE_OPERATION_REMOVE */]; // The first number is how many unmounted IDs we're gonna send.
  ...
  function recordMount(fiber, parentFiber) {
    ...
    if (isRoot) {
      pushOperation(constants["u" /* TREE_OPERATION_ADD */]);
      pushOperation(id);
      ...
      if ((fiber.mode & StrictModeBits) !== 0 && (parentFiber.mode & StrictModeBits) === 0) {
        pushOperation(constants["y" /* TREE_OPERATION_SET_SUBTREE_MODE */]);
        pushOperation(id);
  ...
  function recordProfilingDurations(fiber) {
    ...
    if (isProfiling) {
      ...
      if (alternate == null || treeBaseDuration !== alternate.treeBaseDuration) {
        ...
        pushOperation(constants["A" /* TREE_OPERATION_UPDATE_TREE_BASE_DURATION */]);
        pushOperation(id);
  ...
  function recordResetChildren(fiber, childSet) {
    ...
    pushOperation(constants["x" /* TREE_OPERATION_REORDER_CHILDREN */]);
  ...
  if (Object(storage["d" /* sessionStorageGetItem */])(constants["s" /* SESSION_STORAGE_RELOAD_AND_PROFILE_KEY */]) === 'true') {
    startProfiling(Object(storage["d" /* sessionStorageGetItem */])(constants["r" /* SESSION_STORAGE_RECORD_CHANGE_DESCRIPTIONS_KEY */]) === 'true');
...
function J(a, b, e) {
  var d,
      ...
      k = null,
      h = null;
  if (null != b) for (d in void 0 !== b.ref && (h = b.ref), void 0 !== b.key && (k = "" + b.key), b) G.call(b, d) && !I.hasOwnProperty(d) && (c[d] = b[d]);
...
exports.cloneElement = function (a, b, e) {
  ...
  if (null != b) {
    ...
    for (f in b) G.call(b, f) && !I.hasOwnProperty(f) && (d[f] = void 0 === b[f] && void 0 !== g ? g[f] : b[f]);
  }
...
var h = __webpack_require__(45),
    ...
    q = __webpack_require__(0).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
    w = [],
    x = null;
